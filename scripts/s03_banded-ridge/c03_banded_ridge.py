...
#    assert np.allclose(weights_joint, primal_weights)
    ...
    directory = os.path.join('/dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding/results/banded-ridge-models', '{0}/{1}/{2}_{3}/leftout_run_{4}'.format(align, model, stimfile1,stimfile2, fold_shifted), test_p, hemi)
