...
pca_comp = args.pca
single_folder = f'single-{"".join(features)}'
...
print(f"{alignment} {pca_comp} {features}")
suma_dir = '/Users/h/suma-fsaverage6'
main_dir = '/dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding'
output_dir = os.path.join(main_dir, 'results', 'himalaya', single_folder, f"{alignment}_pca-{pca_comp}")
print(output_dir)
n_splits = 40
