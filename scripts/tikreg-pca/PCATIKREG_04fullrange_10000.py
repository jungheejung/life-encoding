...
increment = 3 #20# 8 hr instead of 30 min
...
directory = os.path.join(scratch_dir, 'PCA_tikreg-loro_fullrange-10000-chunk',
...
subprocess_cmd('cp -rf /scratch/f0042x1/PCA_tikreg-loro_fullrange-10000-chunk/ /dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding/results; rm -rf /scratch/f0042x1/*')
