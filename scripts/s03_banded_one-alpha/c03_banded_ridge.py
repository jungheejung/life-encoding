...
#    assert np.allclose(weights_joint, primal_weights)
    ...
    directory = os.path.join('/dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding/results/banded-ridge_alpha-cara-one', '{0}/{1}/{2}_{3}/leftout_run_{4}'.format(align, model, stimfile1,stimfile2, fold_shifted), test_p, hemi)
    ...
    np.save(os.path.join(directory, 'new-alpha_{0}_model-{1}_align-{2}_feature-{3}_foldshifted-{4}_hemi_{5}.npy'.format(test_p, model, align, stimfile2, fold_shifted,hemi)), new_alphas)
