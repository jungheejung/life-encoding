...
directory = os.path.join(scratch_dir, 'PCA_banded-ridge_alpha-cara_loro',
...
subprocess_cmd('cp -rf /scratch/f0042x1/PCA_banded-ridge_alpha-cara_loro/ /dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding/results; rm -rf /scratch/f0042x1/*')
