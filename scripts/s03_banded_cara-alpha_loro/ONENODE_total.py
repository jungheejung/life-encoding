...
data_dir = '/dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding/results/PCA_banded-ridge_loro_onenode'
...
for align in aligns:
    for model in models:
        ...
        for h in hemispheres:
            ...
            np.save(os.path.join(group_dir, 'total_{0}_model-{2}.{1}.npy'.format(align, h, model)), total)
            mv.niml.write(os.path.join(group_dir, 'total_{0}_model-{2}.{1}.niml.dset'.format(align, h, model)), total)
