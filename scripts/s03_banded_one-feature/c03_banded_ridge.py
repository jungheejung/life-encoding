...
# tikreg
    ...
    fit_banded_polar = models.estimate_stem_wmvnp(X1train, Ytrain,
                                                          X1test_stim,Ytest,
                                                          feature_priors=X1_prior,
   ...
   # assert np.allclose(weights_joint, primal_weights)
    ...
    directory = os.path.join('/dartfs/rc/lab/D/DBIC/DBIC/f0042x1/life-encoding/results/banded-ridge_one-feature', '{0}/{1}/{2}/leftout_run_{4}'.format(align, model, stimfile1, fold_shifted), test_p, hemi)
